...
export const index = ({ product }) => {
  const { name, image_url, prices } = product;
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-sm mx-auto mt-5">
      <Image
        ...
        height={380}
      />
      <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800 z-20">
        <h3 className="py-2 font-bold tracking-wide text-center text-gray-800 uppercase dark:text-white">
          {name}
        </h3>
        <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
          <span className="font-bold text-gray-800 dark:text-gray-200">{`${prices[1].currency} ${prices[1].price}`}</span>
